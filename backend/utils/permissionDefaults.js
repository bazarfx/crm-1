...
const PERMISSION_CATEGORIES = {
  ...
  field_definitions: { label: 'Field Definitions', icon: 'Layers', order: 9 },
};
...
const PERMISSION_DEFINITIONS = [
  ...
  ['leads.view',           'leads', 'View leads',
    { admin: 'all',  schema_editor: 'read', floor_manager: 'all',  senior: 'group', tele_sales: 'own',  back_office: 'read', auditor: 'read', archive: 'none' }],
  ['leads.create',         'leads', 'Create new leads',
    { admin: 'all',  schema_editor: 'read', floor_manager: 'all',  senior: 'none',  tele_sales: 'none', back_office: 'none', auditor: 'none', archive: 'none' }],
  ['leads.edit',           'leads', 'Edit lead details',
    { admin: 'all',  schema_editor: 'read', floor_manager: 'all',  senior: 'group', tele_sales: 'own',  back_office: 'none', auditor: 'none', archive: 'none' }],
  ['leads.soft_delete',    'leads', 'Soft delete leads (move to recycle bin)',
    { admin: 'all',  schema_editor: 'read', floor_manager: 'none', senior: 'none',  tele_sales: 'none', back_office: 'none', auditor: 'none', archive: 'none' }],
  ['leads.reassign',       'leads', 'Reassign leads to different telesellers',
    { admin: 'all',  schema_editor: 'read', floor_manager: 'all',  senior: 'group', tele_sales: 'none', back_office: 'none', auditor: 'none', archive: 'none' }],
  ...
  ['leads.export',         'leads', 'Export lead data to CSV',
    { admin: 'all',  schema_editor: 'read', floor_manager: 'all',  senior: 'group', tele_sales: 'none', back_office: 'none', auditor: 'read', archive: 'none' }],
  ['leads.bulk_operations','leads', 'Bulk assign / bulk update leads',
    { admin: 'all',  schema_editor: 'read', floor_manager: 'all',  senior: 'none',  tele_sales: 'none', back_office: 'none', auditor: 'none', archive: 'none' }],

  // ─── TRIAL LEADS ────────────────────────────────────────────────────────
  ['trial_leads.create',   'trial_leads', 'Create trial / demo leads',
    { admin: 'none', schema_editor: 'read', floor_manager: 'none', senior: 'none', tele_sales: 'none', back_office: 'none', auditor: 'none', archive: 'none' }],
  ...
  ['groups.view',              'groups', 'View groups',
    { admin: 'all', schema_editor: 'read', floor_manager: 'all',  senior: 'group', tele_sales: 'group', back_office: 'none', auditor: 'read', archive: 'none' }],
  ...
  ['reports.own_dashboard', 'reports', 'View own dashboard',
    { admin: 'all', schema_editor: 'read', floor_manager: 'all',  senior: 'all',   tele_sales: 'own',   back_office: 'read', auditor: 'read', archive: 'none' }],
  ['reports.team',          'reports', 'View team / group reports',
    { admin: 'all', schema_editor: 'read', floor_manager: 'all',  senior: 'group', tele_sales: 'group', back_office: 'read', auditor: 'read', archive: 'none' }],
  ['reports.full',          'reports', 'View full / company-wide reports',
    { admin: 'all', schema_editor: 'read', floor_manager: 'all',  senior: 'none',  tele_sales: 'none',  back_office: 'read', auditor: 'read', archive: 'none' }],
  ['reports.ftd',           'reports', 'View FTD reports',
    { admin: 'all', schema_editor: 'read', floor_manager: 'all',  senior: 'group', tele_sales: 'none',  back_office: 'read', auditor: 'read', archive: 'none' }],
  ...
  ['audit_logs.view',          'system', 'View audit logs',
    { admin: 'all',  schema_editor: 'read', floor_manager: 'none', senior: 'none', tele_sales: 'none', back_office: 'none', auditor: 'read', archive: 'none' }],
  ['ark_logs.view',            'system', 'View ARK webhook logs',
    { admin: 'all',  schema_editor: 'read', floor_manager: 'none', senior: 'none', tele_sales: 'none', back_office: 'read', auditor: 'read', archive: 'none' }],
  ...
  // ─── FIELD DEFINITIONS (dynamic custom fields registry) ────────────────
  // schema_editor is the dedicated role for managing custom field schemas;
  // super_admin always has access via the hardcoded shortcut in permissions.js.
  ['field_definitions.view',   'field_definitions', 'View custom field definitions',
    { admin: 'all',  schema_editor: 'all',  floor_manager: 'read', senior: 'read', tele_sales: 'read', back_office: 'read', auditor: 'read', archive: 'none' }],
  ['field_definitions.manage', 'field_definitions', 'Create / edit / archive custom fields',
    { admin: 'none', schema_editor: 'all',  floor_manager: 'none', senior: 'none', tele_sales: 'none', back_office: 'none', auditor: 'none', archive: 'none' }],
];

const NON_EDITABLE_ROLES = ['super_admin'];
const ALL_ROLES = [
  'super_admin', 'admin', 'schema_editor', 'floor_manager', 'senior',
